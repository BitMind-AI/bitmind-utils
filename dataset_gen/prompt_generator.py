...
class PromptGenerator:
    ...
    def _load_vlm_processor(self):
        """Helper method to load the VLM processor"""
    ...
    def _load_vlm(self):
        """Helper method to load the VLM model"""
        import torch
    ...
    def _load_llm_pipeline(self, device=None):
        """Helper method to load the LLM pipeline"""
        import torch
